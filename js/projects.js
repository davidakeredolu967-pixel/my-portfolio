/**
 * Projects Rendering & Editorial Showcase — Studio Edition
 * Large visual project blocks, real screenshot support, and smoked glass case study drawer.
 */
...
function getUiPreviewMockup(project) {
    ...
    return `
      <div class="ui-preview-window">
        <div class="ui-preview-topbar">
          ...
          <span class="badge badge-champagne" style="font-size: 10px;">Prototype</span>
        </div>
        <div class="ui-preview-canvas">
          <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--border-subtle); padding-bottom: 10px;">
            <div>
              <div style="font-size: 13px; font-weight: 600; color: #F1F0EC;">Attendance Management</div>
          ...
          <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px;">
            <div style="background: var(--bg-glass); border: 1px solid var(--border-subtle); border-radius: var(--radius-xs); padding: 8px 10px;">
              <div style="font-family: var(--font-mono); font-size: 14px; font-weight: 700; color: var(--accent-champagne);">124</div>
              <div style="font-size: 10px; color: var(--text-muted);">Checked In</div>
            </div>
            <div style="background: var(--bg-glass); border: 1px solid var(--border-subtle); border-radius: var(--radius-xs); padding: 8px 10px;">
              <div style="font-family: var(--font-mono); font-size: 14px; font-weight: 700; color: #F1F0EC;">98.4%</div>
              <div style="font-size: 10px; color: var(--text-muted);">On-Time Rate</div>
            </div>
            <div style="background: var(--bg-glass); border: 1px solid var(--border-subtle); border-radius: var(--radius-xs); padding: 8px 10px;">
              <div style="font-family: var(--font-mono); font-size: 14px; font-weight: 700; color: #F1F0EC;">08:00 AM</div>
          ...
          <div style="background: rgba(0,0,0,0.3); border: 1px solid var(--border-subtle); border-radius: var(--radius-xs); padding: 8px 12px; font-family: var(--font-mono); font-size: 11px; display: flex; flex-direction: column; gap: 4px;">
            ...
            <div style="display: flex; justify-content: space-between; color: #F1F0EC;">
              <span>Student 01 — Computer Science</span>
              <span style="color: var(--accent-champagne);">08:14 AM ✓</span>
            </div>
            <div style="display: flex; justify-content: space-between; color: #F1F0EC;">
              <span>Student 02 — Mathematical Science</span>
              <span style="color: var(--accent-champagne);">08:12 AM ✓</span>
            </div>
          </div>
        </div>
      </div>
    ...
    return `
      <div class="ui-preview-window">
        <div class="ui-preview-topbar">
          ...
          <span class="badge badge-champagne" style="font-size: 10px;">Firestore</span>
        </div>
        <div class="ui-preview-canvas">
          <div style="display: flex; gap: 8px; flex-wrap: wrap;">
            <span class="badge badge-glass">Breakfast</span>
            <span class="badge badge-glass">Quick Prep</span>
            <span class="badge badge-champagne">Healthy</span>
          </div>
          <div style="background: var(--bg-glass); border: 1px solid var(--border-subtle); border-radius: var(--radius-xs); padding: 12px;">
            <div style="font-size: 14px; font-weight: 600; color: #F1F0EC; margin-bottom: 4px;">Mediterranean Skillet</div>
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; font-family: var(--font-mono); font-size: 11px;">
            <div style="background: rgba(0,0,0,0.3); padding: 8px 10px; border-radius: 4px; border: 1px solid var(--border-subtle);">
              <div style="color: var(--accent-champagne); font-weight: 600; margin-bottom: 2px;">Ingredients (6)</div>
              <div style="color: var(--text-muted); font-size: 10px;">• Eggs, tomatoes, olive oil</div>
            </div>
            <div style="background: rgba(0,0,0,0.3); padding: 8px 10px; border-radius: 4px; border: 1px solid var(--border-subtle);">
              <div style="color: #F1F0EC; font-weight: 600; margin-bottom: 2px;">Timing & Yield</div>
    ...
    return `
      <div class="ui-preview-window">
        <div class="ui-preview-topbar">
          ...
          <span class="badge badge-champagne" style="font-size: 10px;">Shopify Concept</span>
        </div>
        <div class="ui-preview-canvas">
          <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--border-subtle); padding-bottom: 8px;">
            <div style="font-family: var(--font-heading); font-size: 14px; font-weight: 700; letter-spacing: 0.08em; color: #F1F0EC;">AVANTI VOGUE</div>
          ...
          <div style="display: grid; grid-template-columns: 1.2fr 1fr; gap: 8px; align-items: center;">
            <div style="background: var(--bg-glass); border: 1px solid var(--border-subtle); border-radius: var(--radius-xs); padding: 10px;">
              <div style="font-size: 10px; color: var(--accent-champagne); font-family: var(--font-mono); margin-bottom: 2px;">COLLECTION 01</div>
              <div style="font-size: 12px; font-weight: 600; color: #F1F0EC;">Lifestyle Apparel</div>
            ...
            <div style="background: rgba(0,0,0,0.3); border: 1px solid var(--border-subtle); border-radius: var(--radius-xs); padding: 8px; font-family: var(--font-mono); font-size: 10px;">
              ...
              <div style="color: var(--accent-champagne); font-weight: 600;">Product Showcase</div>
    ...
    return `
      <div class="ui-preview-window">
        <div class="ui-preview-topbar">
          ...
          <span class="badge badge-champagne" style="font-size: 10px;">Portfolio</span>
        </div>
        <div class="ui-preview-canvas">
          <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--border-subtle); padding-bottom: 8px;">
            <div style="font-size: 13px; font-weight: 700; color: #F1F0EC;">Studio Architecture</div>
          ...
          <div style="background: var(--bg-glass); border: 1px solid var(--border-subtle); border-radius: var(--radius-xs); padding: 12px; font-size: 11px; color: var(--text-secondary); line-height: 1.5;">
            Smoked architectural glass, restrained champagne accents, fluid clamp typography, and zero heavy dependencies.
          </div>
  ...
  return `
    <div class="ui-preview-window">
      ...
      <div class="ui-preview-canvas">
        <div style="font-size: 13px; font-weight: 600; color: #F1F0EC; margin-bottom: 6px;">Campus & Event Design Assets</div>
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 6px;">
          <div style="background: var(--bg-glass); border: 1px solid var(--border-subtle); border-radius: 4px; padding: 10px; text-align: center;">
            ...
            <div style="font-size: 10px; color: #F1F0EC; font-weight: 500;">Seminars</div>
          </div>
          <div style="background: var(--bg-glass); border: 1px solid var(--border-subtle); border-radius: 4px; padding: 10px; text-align: center;">
            <div style="font-size: 16px; margin-bottom: 2px;">⚡</div>
            <div style="font-size: 10px; color: #F1F0EC; font-weight: 500;">Tech Talks</div>
          </div>
          <div style="background: var(--bg-glass); border: 1px solid var(--border-subtle); border-radius: 4px; padding: 10px; text-align: center;">
            <div style="font-size: 16px; margin-bottom: 2px;">🎨</div>
            <div style="font-size: 10px; color: #F1F0EC; font-weight: 500;">Social Graphics</div>
          </div>
        </div>
        ...
        <article class="project-editorial-row reveal-on-scroll" id="${project.id}">
          ...
          <div class="project-info-col">
            <div class="project-meta-header">
              ...
              <span class="badge badge-champagne">
                ● ${project.statusBadge}
              </span>
            </div>
            ...
            <div style="background: var(--bg-glass); border-left: 2px solid var(--accent-champagne); padding: 8px 12px; border-radius: 0 var(--radius-xs) var(--radius-xs) 0;">
              <div style="font-size: 11px; font-family: var(--font-mono); color: var(--accent-champagne); text-transform: uppercase;">Problem Addressed</div>
...
/**
 * 2. Render Skills Capabilities (Clean Grouped Typographic Layout)
 */
function initSkills() {
  ...
  const categories = [
    ...
    { title: "Approach & Mindset", items: approach }
  ];

  mount.innerHTML = `
    <div class="skills-grouped-grid">
      ${categories.map(cat => `
        <div class="skills-group-block reveal-on-scroll">
        ...
        <div class="journey-step-node reveal-on-scroll">
          ...
          <div class="journey-step-card">
            <div class="journey-step-top">
              ...
              <span class="badge badge-champagne" style="font-size: 10px;">${item.period}</span>
            </div>
...
function openProjectModal(projectId) {
  ...
  modalBody.innerHTML = `
    <div style="display: flex; flex-direction: column; gap: var(--space-md);">
      ...
      <h2 style="font-size: var(--font-size-xl); color: #F1F0EC;">${project.title}</h2>
      ...
      <div style="background: var(--bg-glass); border: 1px solid var(--border-subtle); border-radius: var(--radius-sm); padding: var(--space-md);">
        <h4 style="font-size: var(--font-size-xs); font-family: var(--font-mono); color: var(--accent-champagne); text-transform: uppercase; margin-bottom: 8px;">
          Key Features
        </h4>
      ...
      <div style="display: flex; flex-direction: column; gap: var(--space-sm); margin-top: 4px;">
        ...
        <div style="background: var(--bg-glass); border-left: 2px solid var(--accent-champagne); padding: 8px 12px; border-radius: 0 var(--radius-xs) var(--radius-xs) 0;">
          <strong style="color: var(--accent-champagne); font-size: 11px; text-transform: uppercase; font-family: var(--font-mono);">The Approach</strong>
